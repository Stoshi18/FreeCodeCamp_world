...
echo "$($PSQL "SELECT name FROM teams AS t INNER JOIN games ON t.team_id = games.winner_id OR t.team_id = games.opponent_id WHERE year = 2014 AND round = 'Eighth-Final' ORDER BY name")"
