...
--
-- Name: games games_enemies_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_enemies_id_fkey FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
